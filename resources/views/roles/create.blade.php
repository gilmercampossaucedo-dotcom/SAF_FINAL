        ...
        <div class="col-md-9">
            <div class="card card-custom">
                <div class="card-header bg-white pt-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-shield-alt me-2 text-warning"></i>Crear Nuevo Rol</h5>
                    ...
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Ej: supervisor, bodeguero..." required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            <label class="form-label text-muted small fw-bold d-block mb-3">
                                PERMISOS DEL ROL
                                <span class="text-muted fw-normal ms-2">— Selecciona los que apliquen</span>
                            </label>

                            {{-- $grouped comes pre-built from RoleController::create() --}}
